...
function BeatsPage() {
  ...
  const all = useMemo(() => beats.data ?? [], [beats.data]);
    ...
    <div className="mx-auto max-w-6xl px-5 py-14 sm:px-8 sm:py-20">
      <header>
        ...
        <p className="mt-3 max-w-xl text-sm text-muted-foreground">
          Every instrumental streams in full-preview quality. Found the one? Send a WhatsApp inquiry
          straight from the beat page.
        </p>
      </header>
