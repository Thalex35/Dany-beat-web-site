  ...
  head: () => ({
    meta: [
      ...
      { title: "Dany Beats — Premium Rap & Trap Instrumentals" },
      {
        name: "description",
        content:
          "Stream and license original rap, trap and afro instrumentals from producer Dany Beats.",
      },
      { name: "author", content: "Dany Beats" },
      { property: "og:title", content: "Dany Beats — Premium Rap & Trap Instrumentals" },
      {
        property: "og:description",
        content: "Stream and license original instrumentals from producer Dany Beats.",
      },
